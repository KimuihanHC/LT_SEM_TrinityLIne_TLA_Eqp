...
#define	CL_DELAY_TIMER_MIN	0			//!< ’x‰„ŽžŠÔÅ¬[•b]
#define	CL_DELAY_TIMER_MAX	999			//!< ’x‰„ŽžŠÔÅ‘å[•b]

#define	CL_INTERBAL_TIMER_MIN	0		//!< ‘ª’èŽüŠúÅ¬[•b]
#define	CL_INTERBAL_TIMER_MAX	999		//!< ‘ª’èŽüŠúÅ‘å[•b]
...
{
	CL_MESURE_DISPLAY_SINGLE_LOG=0,							//!< ‘ª’èƒf???Ž¦
