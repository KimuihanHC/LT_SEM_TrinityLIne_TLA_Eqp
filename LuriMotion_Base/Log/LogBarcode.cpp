...
CLogBarcode::CLogBarcode( LPCTSTR lpszServiceName ) :
...
void CLogBarcode::GetLogPathName( CTime& Time, CExString& strLogPathName )
{
...
void CLogBarcode::GetCSVPathName( CTime& Time, CExString& strCSVPathName )
{
	int nYear = Time.GetYear();
	int nMonth = Time.GetMonth();
	int nDay = Time.GetDay();
...
void CLogBarcode::UseCSVFile( BOOL bUse, LPCTSTR lpszCSVHeader )
{
	m_bUseCSVFile = bUse;
	m_strCSVHeader.Format( _T("%s\r\n"), lpszCSVHeader );
}

void CLogBarcode::UseTextFile( BOOL bUse )
{
	m_bUseTxtFile = bUse;
}

void CLogBarcode::UseMonthlySplitFolder( BOOL bUse )
{
	m_bMonthlySplitFolder = bUse;
}

BOOL CLogBarcode::Start()
{
...
BOOL CLogBarcode::OpenCSVFile( CExString& strCSVPathName )
{
	if ( !m_bUseCSVFile )
		return TRUE;
...
void CLogBarcode::LogOut( LPCTSTR lpszId, LPCTSTR lpszFormat, ... )
{
...
void CLogBarcode::DeleteExpiredCSVFile()
{
...
void CLogBarcode::DeleteExpiredLogFile()
{
...
void CLogBarcode::CreateFolder(LPCTSTR lpszPath)
{
