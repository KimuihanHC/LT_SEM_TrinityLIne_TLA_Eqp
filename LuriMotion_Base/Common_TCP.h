...
typedef struct _SCREW_LOG_DATA
{
	CString strParameterSet;
	int     nParameterSet;

	CString strPeakTorque;	//30230
	CString strTotalAngle;	//30231
	CString strDuration;	//30232
	CString strTooltemperture;
	CString strTotalAngleStatus;
